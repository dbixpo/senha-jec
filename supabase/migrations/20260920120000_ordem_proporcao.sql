-- Ordem de chamada com proporção: N senhas normais para cada P preferenciais.
-- A chegada dentro de cada grupo não muda. Preferencial na frente da fila não espera.
-- Padrão: 2 comuns para 1 preferencial.
...
set valor = 'proporcao'
where chave = 'ordem_chamada'
  and valor is not distinct from 'intercalar';
